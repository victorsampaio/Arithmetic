...
public class CalculateAddition extends Activity {
    private static final String CATEGORY = "addActivity";
    Button btnSum;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSum = (Button)findViewById(R.id.btnResult);
...
// Operation
    ...
    private void sumOperation() {
        ...
        TextView msg = (TextView)findViewById(R.id.txtResult);
