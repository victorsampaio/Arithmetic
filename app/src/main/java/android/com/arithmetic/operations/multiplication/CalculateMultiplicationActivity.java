...
public class CalculateMultiplicationActivity extends Activity {
    private static final String CATEGORY = "operationMult";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calculate_multiplication);
    ...
    private void multOperation() {
        EditText etNum1 = (EditText)findViewById(R.id.firstN);
        Log.i(CATEGORY, "EditText 1 ok ");
        EditText etNum2 = (EditText)findViewById(R.id.secondN);
